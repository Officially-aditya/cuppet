...
export default function PhoneMockup() {
  ...
  return (
    <div className="relative w-full max-w-[390px] select-none">
      <span
        aria-hidden="true"
        className="pointer-events-none absolute -left-3 -top-3 z-20 h-10 w-10 border-l border-t border-[var(--forest)]/85"
      />
      <span
        aria-hidden="true"
        className="pointer-events-none absolute -right-3 -top-3 z-20 h-10 w-10 border-r border-t border-[var(--forest)]/85"
      />
      <span
        aria-hidden="true"
        className="pointer-events-none absolute -bottom-3 -left-3 z-20 h-10 w-10 border-b border-l border-[var(--forest)]/85"
      />
      <span
        aria-hidden="true"
        className="pointer-events-none absolute -bottom-3 -right-3 z-20 h-10 w-10 border-b border-r border-[var(--forest)]/85"
      />
